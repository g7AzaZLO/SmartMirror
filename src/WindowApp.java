...
public class WindowApp extends JFrame { //Наследуя от JFrame мы получаем всю функциональность окна
    ...
    public WindowApp(){
        ...
        Font mainFont = new Font("DolomanPavljenko",Font.PLAIN, 35);
        Font calendarFont = new Font("DolomanPavljenko",Font.PLAIN, 25);
        Font frazeFont = new Font("DolomanPavljenko",Font.PLAIN, 50);
        Font timeFont = new Font("DolomanPavljenko",Font.PLAIN, 47);
